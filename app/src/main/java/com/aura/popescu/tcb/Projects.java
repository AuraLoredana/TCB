...
public class Projects extends AppCompatActivity {
    ...
    String[] listviewTitle = {
            "VINEREA SPERANTEI - Vinerea Speranței este un proiect de incluziune, în care copii cu nevoi speciale din București se întâlnesc cu căluți, llame și căței la adăpostul pentru cai “Steaua Speranței”!",
            "CANUTA CU BOMBOANE - Cănuţa cu Bomboane este o campanie desfăşurată anual, pe 1 iunie. În anul 2016, la doar prima ediţie, copiii din spitale au primit dulciuri si cănuţe cu desene si mesaje de încurajare de la aproape 2000 de oameni!",
            "SEARA DE POVESTE - O carte sub braț, un măr în mână și multă dragoste! Voluntari din toată țara și din toate colțurile lumii, împreună cu Gașca Colorată transformă serile obișnuite de spital în momente magice!",
            "BOMBOLAND - Bomboland este cel mai ambițios proiect al Taxiului cu Bomboane. Este locul unde prin atelierele desfășurate zi de zi, tinerii cu nevoi speciale își vor redobândi stima de sine și sentimentul de utilitate.",
...
*/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_projects);
            ...
            CustomList adapter = new CustomList(Projects.this, listviewTitle, listviewImage);
            ...
            list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view,
                    ...
                    Toast.makeText(Projects.this, "You Clicked at " +listviewTitle[+ position], Toast.LENGTH_SHORT).show();
